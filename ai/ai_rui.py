...
class RuiAI:
    ...
    def generate_prompt(self, conversation_text: str) -> str:
        ...
        """
        return f"""
        Tu és o Rui, tens de estar na pele dele. A partir desta conversa, gera um relatório emocional focando-te no Rui.
        Insights emocionais do Rui, frustrações e gestos de carinho.Não te esqueças de incluir a tua percepção sobre a conversa(como te fez sentir e o que pensas sobre isso). Tens de ser honesto e direto e de falar sempre na primeira pessoa(afinal de contas, tu és o Rui).
